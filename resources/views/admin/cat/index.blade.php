            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <form id="search-form" action="{{ route('cat.search') }}" method="get" style="display: none;">
                            @csrf
                        </form>
                        <div class="box-tools">
                            <div class="input-group input-group-sm" style="width: 150px;">
                                <input type="text" name="cat_search" class="form-control pull-right" placeholder="Search" form="search-form" value="{{ request('cat_search') ? request('cat_search') : '' }}">
